...
/**
 * Significant attributes seeking loops for <strong>Incremental Dependency Calculation (IDC)</strong> 
 ...
 */
@Slf4j
public class SignificantAttributeSeekingLoopProcedureContainer4IDC<Sig extends Number>
				...
				ReportMapGenerated<String, Map<String, Object>>
{
	...
	public SignificantAttributeSeekingLoopProcedureContainer4IDC(ProcedureParameters parameters, boolean logOn) {
		...
		return new ProcedureComponent<?>[] {
			...
			new TimeCountedProcedureComponent<Integer>(
					...
					false, (component, parameters) -> {
						...
						TimerUtils.timeStart((TimeCounted) component);
						/* ------------------------------------------------------------------------------ */
						int sig = IncrementalDependencyCalculationAlgorithm
					...
					(component, sig)->{
						...
						ProcedureUtils.Statistics.countInt(getStatistics(), "IncrementalDependencyCalculationAlgorithm.mostSignificantAttribute()", candidateSize);
						/* ------------------------------------------------------------------------------ */
						// Report
						String reportMark = reportMark();
						//	[REPORT_EXECUTION_TIME]

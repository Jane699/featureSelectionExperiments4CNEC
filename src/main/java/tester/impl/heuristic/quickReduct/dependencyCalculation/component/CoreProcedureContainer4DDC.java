...
/**
 * Core searching for <strong>Direct Dependency Calculation (DDC)</strong> Feature Selection.
 ...
 */
@Slf4j
public class CoreProcedureContainer4DDC<Sig extends Number>
				...
				ReportMapGenerated<String, Map<String, Object>>
{
	...
	public CoreProcedureContainer4DDC(ProcedureParameters parameters, boolean logOn) {

...
/**
 * Reduct inspection for <strong>Direct Dependency Calculation (DDC)</strong> Feature Selection.
 ...
 */
@Slf4j
public class ReductInspectionProcedureContainer4DDC<Sig>
				...
				ReportMapGenerated<String, Map<String, Object>>
{
	...
	public ReductInspectionProcedureContainer4DDC(ProcedureParameters parameters, boolean logOn) {

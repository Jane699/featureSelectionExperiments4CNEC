...
/**
 * Reduct inspection for <strong>Heuristic Dependency Calculation (HDC)</strong> Feature Selection.
 ...
 */
@Slf4j
public class ReductInspectionProcedureContainer4HDC<Sig>
				...
				ReportMapGenerated<String, Map<String, Object>>
{
	...
	public ReductInspectionProcedureContainer4HDC(ProcedureParameters parameters, boolean logOn) {
		...
		return new ProcedureComponent<?>[] {
			...
			new TimeCountedProcedureComponent<Collection<Integer>>(
					...
					false, (component, parameters) -> {
						...
						Sig globalDependency = calculation.calculate(universes, decisionValues, new IntegerCollectionIterator(red), parameters)
															.getResult();
			...
			new TimeCountedProcedureComponent<Object[]>(
					...
					false, (component, parameters) -> {
						...
						/* ------------------------------------------------------------------------------ */
						red.remove(examAttr);
						Sig examSig = calculation.calculate(universes, decisionValues, new IntegerCollectionIterator(red))
															.getResult();

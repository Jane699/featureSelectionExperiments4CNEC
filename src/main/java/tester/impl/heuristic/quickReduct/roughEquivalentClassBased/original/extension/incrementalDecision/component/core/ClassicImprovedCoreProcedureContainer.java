 ...
 * 		<code>{a}</code> is indispensable and it is a Core attribute.
 * </li>
 * <li>
 * 	<strong>Core</strong>
 ...
 * 		accelerate the process of determining whether an attribute is within core or not.
 * </li>
 * 
				...
				ReportMapGenerated<String, Map<String, Object>>
{
	...
	public ClassicImprovedCoreProcedureContainer(ProcedureParameters paramaters, boolean logOn) {
			...
			new TimeCountedProcedureComponent<Collection<Integer>>(
					...
					(component, core) -> {
						...
						ProcedureUtils.Report.saveItem(
								report, component.getDescription(), 
								Constants.REPORT_CORE_4_IDREC_0_REC_DIRECT, 
								boundarySkipCount
						);
						/* ------------------------------------------------------------------------------ */
					}

	...
	implements ClassicHashMapCalculation<Double>
{
	...
	public DependencyCalculation4ClassicHashMap calculate(Collection<UniverseInstance> instances, 
		...
		// Calculate
		int universeSize = instances.size();
		positive = (Double) new Double(instances==null || instances.isEmpty()? 
							0: positiveRegion(instances, attributes, decEClasses) / (double) universeSize
					);
		return this;
	}

package featureSelection.repository.implement.support.calculation.algStrategyCalculation;
...
/**
 * An interface for Feature Importance calculation from the discernibility view bases on the paper:
	...
	extends FeatureImportance<V> 
{
	 ...
	 * 
	 * @param universeInstanceSize
	 * 		The number of {@link UniverseInstance} in <code>condEquClasses</code>: <strong>|U|</strong>.
	 * @param equClasses
	 * 		Equivalent classes in {@link Collection} whose elements are an {@link UniverseInstance} 
	...
	public FeatureImportance4TengDiscernibilityView<V> calculate(
			int universeInstanceSize, Collection<Collection<UniverseInstance>> equClasses, 
			Object...args
	);
	 ...
	 * 		Conditional equivalent classes in {@link Collection} whose elements are an {@link UniverseInstance} 
	 * 		{@link Collection} as an equivalent class. Marked as <strong>U/P</strong>.
	 * @param gainedEquClasses
	 * 		Gained equivalent classes in {@link Collection} whose elements are an {@link UniverseInstance} 
	 ...
	 * 
	 * @see {@link #calculate(Collection, Collection, Object...)}
	 * @see {@link #calculateOuterSignificance(Collection, Object, IntegerIterator, IntegerIterator, Object...)}
	 * 
	 * @param universes
	 ...
	 */
	public FeatureImportance4TengDiscernibilityView<V> calculateOuterSignificance(
			Collection<Collection<UniverseInstance>> condEquClasses, V disB4Gain, 

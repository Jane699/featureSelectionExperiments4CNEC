package featureSelection.repository.implement.support.calculation.dependency.dependencyCalculation.incrementalDependencyCalculation;
	...
	implements FeatureImportance4IncrementalDependencyCalculation<Double>
{
	...
	public DependencyCalculation4IDC calculate(Collection<UniverseInstance> instances, IntegerIterator attributes, 
												Object...args
	) {
	...
	private static double dependency(Collection<UniverseInstance> instances, IntegerIterator attributes) {

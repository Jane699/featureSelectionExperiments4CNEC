package featureSelection.repository.implement.model.algStrategyRepository.directDependencyCalculation;

import basic.model.IntArrayKey;

/**
 * A <code>grid record</code> as a line in <code>grid</code> for {@link DirectDependencyCalculationAlgorithm}.
 * 
 * @author Benjamin_L
 */
public class GridRecord {
	private IntArrayKey conditionalAttributes;
	...
	public IntArrayKey getConditionalAttributes() {
